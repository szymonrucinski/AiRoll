...
button_load_movies = Button(window,  
                        text = "Load Movies", 
                        command = browseDir, bg='#871719', borderwidth=0, cursor='hand2')  

button_select_audio = Button(window,  
                        text = "Select Audio", 
                        command = browseFiles, bg='#871719', borderwidth=0, cursor='hand2') 

button_action = Button(window,  
                     text = "Action", 
                     command = lambda: threading.Thread(target=start_edit).start(), bg='#871719', borderwidth=0, cursor='hand2')
...
select_audio_img = PhotoImage(file = os.path.join(ASSETS_DIR,'select_audio.png'))
...
style.configure("grey.Horizontal.TProgressbar", background='#FFF200', borderwidth=0)
